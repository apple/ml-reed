...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-envs", type=int, default=32, help="the number of environment instances to train on")
    parser.add_argument("-tb", "--tensorboard-log", help="Tensorboard log dir",
                        default="/mnt/task_wrapper/user_output/artifacts/", type=str)
    parser.add_argument("--seed", help="Random generator seed", type=int, default=123)
    parser.add_argument("--n-tasks", help="# of parallel environments", type=int, default=16)
    ...
    # save args
    with open(os.path.join(args.tensorboard_log, "experiment_config.yaml"), "w") as f:
    ...
    model.custom_replay_buffer.save(Path(args.tensorboard_log) / f"replay_buffer_{args.total_timesteps}.npz")
